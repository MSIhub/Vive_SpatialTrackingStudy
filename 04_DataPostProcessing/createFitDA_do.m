...
str = {'T: F(2) = 0.615296' 'C: F(2) = 0.812617'  'H: F(2) = 0.914467'};
FontSize = 9;
LineWidth = 1.2;
dim = [.55 .4 .27 .17];
...
hLegend = legend(LegHandles,LegText,'Orientation', 'vertical', 'FontSize',FontSize, 'Location', 'northeast', 'FontName', 'CMU Serif', 'fontweight','bold');
