...
for itr1 = startItr:1:num_of_path
    ...
    str1 = ['SA_H_path', num2str(itr1)];
    P = ['F:\OneDrive - unige.it\ViveStudy\3_Experimentation\2_HMD\1_PrecisionEvaluation\RawData\', str1];
    ...
    path1 = load("PathData/SA_H_Path1.txt");
...
for itr1 = startItr:1:num_of_path
    ...
    fileName = [folderName, 'SA_H_path', num2str(itr1),'.mat'];
    load(fileName);
