...
for itr1 = startItr:1:num_of_path
    ...
    str1 = ['SA_T_path', num2str(itr1)];
    P = ['F:\OneDrive - unige.it\ViveStudy\3_Experimentation\0_Tracker\1_PrecisionEvaluation\RawData\', str1];
    ...
    path1 = load("PathData/SA_T_Path1.txt");
    ...
    pointsinPath = pointsinOnePath(C,V.tracker5,Points);
...
for itr1 = startItr:1:num_of_path
    ...
    fileName = [folderName, 'SA_T_path', num2str(itr1),'.mat'];
    load(fileName);
