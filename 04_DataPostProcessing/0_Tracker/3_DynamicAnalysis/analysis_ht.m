...
velName = "HT";
% data.SS1 = load(['Results\DA_T_', char(velName),'_SS1.mat']);
% data.SM1 = load(['Results\DA_T_', char(velName),'_SM1.mat']);
% data.SF1 = load(['Results\DA_T_', char(velName),'_SF1.mat']);
% data.PS1 = load(['Results\DA_T_', char(velName),'_PS1.mat']);
% data.PM1 = load(['Results\DA_T_', char(velName),'_PM1.mat']);
% data.PF1 = load(['Results\DA_T_', char(velName),'_PF1.mat']);
% data.PM2 = load(['Results\DA_T_', char(velName),'_PM2.mat']);
data.PF2 = load(['Results\DA_T_', char(velName),'_PF2.mat']);


fields = fieldnames(data);
resultFile = ['Results\DA_T_', char(fields(1)),'.mat'];
