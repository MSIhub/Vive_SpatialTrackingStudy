function createFitPE_do(C_do,H_do,T_do)
...
str = {'T: F(0.1) = 0.972598' 'C: F(0.1) = 0.333333'  'H: F(0.1) = 0.784707'};
...
xlabel('Deviation from mean [$deg^{\circ}$]');
...
hLegend = legend(LegHandles,LegText,'Orientation', 'vertical', 'FontSize', FontSize, 'Location', 'best', 'FontName', 'CMU Serif', 'fontweight','bold');
